...
for image in image_path:
    ...
    for i in range(len(a[0])):
        Green_trainingData[0].append(img_tcrcb[a[0][i],a[1][i],0])
        Green_trainingData[1].append(img_tcrcb[a[0][i],a[1][i],1])
        Green_trainingData[2].append(img_tcrcb[a[0][i],a[1][i],2])
file = open("GreenData","wb")
pickle.dump(Green_trainingData,file)
file.close()
